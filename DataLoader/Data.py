...
class Data:
    ...
    def step(self, action):
        ...
        if self.current_state_index + self.n_step < len(self.states):
            ...
            next_label = self.data['reward_label'].iloc[self.current_state_index + self.n_step]
        else:
            done = True
        ...
        label = self.data['reward_label'].iloc[self.current_state_index]
        
        
        if self.is_SC:
            return done, reward, next_state, label, next_label
        else:
